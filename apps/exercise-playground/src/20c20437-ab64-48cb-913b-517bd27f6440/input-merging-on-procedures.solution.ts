// http://localhost:3004/courses/exercises/20c20437-ab64-48cb-913b-517bd27f6440/edit
...
const withCurrentUrlProcedure = publicProcedure
  .input(
    z.object({
      currentUrl: z.string(),
    })
  ...
  .use(async (opts) => {
    console.log(opts.input.currentUrl);

    return opts.next();
  });

const appRouter = t.router({
  greetMe: withCurrentUrlProcedure
    .input(
      z.object({
        name: z.string(),
      })
